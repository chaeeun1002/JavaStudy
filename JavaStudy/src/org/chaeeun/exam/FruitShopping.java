...
class MyButton implements ActionListener{
	...
	MyButton(FruitShopping shopping,TotalSystem total){
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == shopping.first) {
			...
			total.card.show(total.total_panel, "login");
			total.menu_logout.setEnabled(false);
			total.menu_fruit.setEnabled(false);
			total.menu_drink.setEnabled(false);
			total.menu_home.setEnabled(false);
...
public class FruitShopping extends Panel {
...
//	}
	...
	void init(TotalSystem total) {//컴포넌트 생성
	...
	public FruitShopping(TotalSystem total) {
//		super(str);
